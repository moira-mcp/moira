...
export enum AuditAction {
  ...
  // Codespace provider connections (metadata only; credentials are never audit payloads)
  CODESPACE_CONNECTION_START = "codespace:connection_start",
  CODESPACE_CONNECTION_COMPLETE = "codespace:connection_complete",
  CODESPACE_CONNECTION_REFRESH_FAILED = "codespace:connection_refresh_failed",
  CODESPACE_CONNECTION_DISCONNECT = "codespace:connection_disconnect",
  CODESPACE_RESOURCE_CREATE = "codespace:resource_create",
  CODESPACE_RESOURCE_CREATE_PENDING = "codespace:resource_create_pending",
  CODESPACE_RESOURCE_CREATE_REJECTED = "codespace:resource_create_rejected",
  CODESPACE_RESOURCE_CLEANUP = "codespace:resource_cleanup",
  CODESPACE_RESOURCE_START = "codespace:resource_start",
  CODESPACE_RESOURCE_STOP = "codespace:resource_stop",
  CODESPACE_RESOURCE_DELETE = "codespace:resource_delete",
  CODESPACE_OPERATION_RESERVE = "codespace:operation_reserve",
  CODESPACE_OPERATION_RECONCILE = "codespace:operation_reconcile",
  CODESPACE_OPERATION_TERMINAL = "codespace:operation_terminal",
  CODESPACE_CONTROL_UPDATE = "codespace:control_update",

...
Непроизводственный пример `workflows/examples/flows/b33e227c-cc2c-4931-ae5d-2de69932e41e.json`
использует write-note после сбора потребностей пользователя:

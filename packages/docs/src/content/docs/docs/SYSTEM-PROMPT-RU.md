...
4. **Многошаговая задача** → Всегда предлагать `moira/robust-task`
   - Сохраняет планы, попытки, решения и evidence для восстановления после потери контекста
   - Использует причинно-ориентированное независимое ревью, ограниченный repair результата/evidence и replanning вместо молчаливого принятия нерешённой работы
...
| `moira/verified-research`              | Один ограниченный вопрос по внешним источникам с долговечными evidence, independent semantic review и честным complete- или limited-локальным ответом                                                  |

...
```bash
mcp__moira__start({ action: "prepare", workflowId: "moira/startup-idea-validation", parentExecutionId: "none" })
...
- Publication and user notification are separate optional effects. Tool availability is not authority.

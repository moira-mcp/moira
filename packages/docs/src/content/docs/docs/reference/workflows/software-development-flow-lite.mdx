...
- [Software Development Flow](./software-development-flow/) — high-risk, spreading, multi-unit, migration, breaking-contract, or rollout-heavy software delivery.
...
- [Workflow Management Flow](./workflow-management-flow/) — create or edit a Moira workflow definition itself.

...
The non-production example at `workflows/examples/flows/b33e227c-cc2c-4931-ae5d-2de69932e41e.json`
uses a write-note node after it has collected the user's needs:

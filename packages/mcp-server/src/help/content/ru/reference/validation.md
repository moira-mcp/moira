...
- **Типы узлов расширений** - Для типов из live-реестра расширений проверяется объявленная ими
  схема конфигурации. Если live-реестр не содержит тип, это ошибка; при отсутствии достоверных
  live-данных реестра валидатор вместо ошибки выдаёт предупреждение о невозможности разрешить тип

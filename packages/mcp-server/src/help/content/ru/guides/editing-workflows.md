...
Решение: выберите встроенный тип из [справочника узлов](/ru/docs/concepts/nodes/). Для типа
расширения с пространством имён убедитесь, что расширение установлено. Валидатор без достоверных
live-данных реестра сообщает, что тип не удалось разрешить; live-реестр без этого типа сообщает
об ошибке.

...
```json
{
  "properties": {
    "issues_count": {
      "type": "number",
      "minimum": 0,
      "description": "Number of reproducible blocking findings in the report; zero is valid"
    },
    "evidence": {
      "type": "string",
...
> **note:** Descriptions are shown to agents in validation errors and help prompts.

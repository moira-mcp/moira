...
- `tests/unit/shared/codespace-provider-registry.test.ts` — reviewed provider IDs, version-3 contract acceptance with explicit version-2 rejection, duplicate rejection and provider-neutral lookup

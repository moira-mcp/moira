...
- `tests/e2e/dashboard.spec.ts` — dashboard statistics and quick actions, the "Connect your agent" card with its per-client tabs, and the sidebar and connection-card documentation links, which open the Russian documentation for a Russian reader

...
| `WORKSPACE_GITHUB_APP_CLIENT_SECRET`     | Server-only secret generated by GitHub                              |
| `WORKSPACE_GITHUB_APP_CALLBACK_URL`      | Same-origin URL with exact `/api/integrations/github/callback` path |
...
| `WORKSPACE_CREDENTIAL_VAULT_KEY_VERSION` | Key identifier; defaults to `v1`                                    |
